...
#Taxonomy[which(rownames(Taxonomy) == "SeqVar151"),]
colnames(wide.data)[2] <- "Rhizobium_SeqVar11"
colnames(wide.data)[6] <- "Comamonadaceae_SeqVar52"
colnames(wide.data)[13] <- "Fibrobacteraceae_SeqVar106"
colnames(wide.data)[14] <- "Microscillaceae_SeqVar115"
colnames(wide.data)[17] <- "Blastocatellaceae_SeqVar151"
...
#saveRDS(long_taxa_data, file = "long_taxa_data_bacteria.RDS")
