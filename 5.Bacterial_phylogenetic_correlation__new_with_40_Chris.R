...
#write.table(phylo.matrix, file = "final_phylogeny.txt")
...
table(phylo_metadata$Taxonomia)
...
#saveRDS(PCOA_phylo, file = "PCOA_phylo.RDS")



adonis2(phylo.matrix ~ phylo_standardized_meta$ALT)
